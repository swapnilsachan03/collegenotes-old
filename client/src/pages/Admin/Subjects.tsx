import { Button, Flex, Heading, HStack, Stack, Table, TableCaption, TableContainer, Tbody, Td, Th, Thead, Tr, useDisclosure } from '@chakra-ui/react';
    ...
    <Tr>
      ...
      <Td isNumeric>
        <HStack justifyContent={"flex-end"}>
          ...
          <a href={`/subject/${element._id}`} target={"_blank"}>
